...
import { getEntities, reset } from './order-info.reducer';
...
export const OrderInfo = (props: IOrderInfoProps) => {
  ...
  const { orderInfoList, match, loading } = props;
  return (
    <div>
      ...
      <div className="table-responsive">
        ...
        >
          {orderInfoList && orderInfoList.length > 0 ? (
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-right">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`${match.url}/${orderInfo.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                          <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Edit</span>
                        </Button>
                        <Button tag={Link} to={`${match.url}/${orderInfo.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
            ...
            !loading && <div className="alert alert-warning">No Order Infos found</div>
          )}
        </InfiniteScroll>
      </div>
    </div>
