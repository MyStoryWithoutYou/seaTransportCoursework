  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="seaTransportApp.order.home.createOrEditLabel" data-cy="OrderCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : orderEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="customerLabel" for="order-customer">
                  Customer
                </Label>
                <AvField
                  id="order-customer"
              ...
              <AvGroup>
                <Label id="portLabel" for="order-port">
                  Port
                </Label>
                <AvField
                  id="order-port"
              ...
              <AvGroup>
                <Label id="dateOfLoadingLabel" for="order-dateOfLoading">
                  Date Of Loading
                </Label>
                <AvField id="order-dateOfLoading" data-cy="dateOfLoading" type="date" className="form-control" name="dateOfLoading" />
              </AvGroup>
              <AvGroup>
                <Label id="dateOfShipmentLabel" for="order-dateOfShipment">
                  Date Of Shipment
                </Label>
                <AvField id="order-dateOfShipment" data-cy="dateOfShipment" type="date" className="form-control" name="dateOfShipment" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="transportLabel" for="order-transport">
                  Transport
                </Label>
                <AvField
                  id="order-transport"
