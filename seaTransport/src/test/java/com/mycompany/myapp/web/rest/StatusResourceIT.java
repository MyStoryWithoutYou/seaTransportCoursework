...
class StatusResourceIT {
    ...
    public static Status createEntity(EntityManager em) {
        Status status = new Status().statusName(DEFAULT_STATUS_NAME).description(DEFAULT_DESCRIPTION);
        return status;
    }
    ...
    public static Status createUpdatedEntity(EntityManager em) {
        Status status = new Status().statusName(UPDATED_STATUS_NAME).description(UPDATED_DESCRIPTION);
        return status;
    }
    ...
    void putNewStatus() throws Exception {
        ...
        updatedStatus.statusName(UPDATED_STATUS_NAME).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateStatusWithPatch() throws Exception {
        ...
        partialUpdatedStatus.statusName(UPDATED_STATUS_NAME).description(UPDATED_DESCRIPTION);
